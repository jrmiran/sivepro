...
export class CreatePdfComponent implements OnInit {
  ...
  constructor() { }
    ...
    public gerarPDF(items: BudgetAmbient[], mainBudget: BudgetModel) {
        ...
        var column=[{title:"", key:"cmd"},{title:'', key:"value"}];
        var row = [{cmd:"",value:""}];
        
        var columnTotal = [{title:"", key:"valor"}];
        
        
        var styleColumnAmbient = {
            cmd:{cellWidth: 300, halign: 'left'}, 
            value: {cellWidth: 276, fontStyle: 'bold', halign: 'right'}
        };
        ...
        //Line with Budget Number and date
        doc.autoTable(columnsInfo1, [{budgetNumber: "Orçamento No.: 2059", date: "Data: " + mainBudget.date}], {theme: 'grid', 
            columnStyles: {
                            budgetNumber: {cellWidth: 400, fontStyle: 'bold', halign: "left"},
                            date: {cellWidth: 172, fontStyle: 'bold', halign: "left"},
                          },
        ...
        if(mainBudget.client.type == "LOJ"){
            doc.autoTable(columnsInfo2, [{column1: "Loja: " + mainBudget.client.name, column2: ""},
                          ...
                          {theme: 'grid', 
                          columnStyles: {
                                        column1: {cellWidth: 400, fontStyle: 'bold', halign: "left"},
                                        column2: {cellWidth: 172, fontStyle: 'bold', halign: "left"},
                                      },
                          styles: {halign: "center"},                       
                          margin:{left: 10, top: 50},
            ...
            doc.autoTable(columnsInfo3, [{column3: "Cliente: " + mainBudget.terceiro.name, column4: ""},
                          ...
                          {theme: 'grid', 
                          columnStyles: {
                                        column3: {cellWidth: 400, fontStyle: 'bold', halign: "left"},
                                        column4: {cellWidth: 172, fontStyle: 'bold', halign: "left"},
                                      },
                          styles: {halign: "center"},                       
                          margin:{left: 10, top: 50},
                          startY: doc.previousAutoTable.finalY                
        ...
        doc.autoTable(columnTotal, [{valor: "ORÇAMENTO"}],
                          {theme: 'grid', 
                          columnStyles: {
                                        valor: {cellWidth: 572, fontStyle: 'bold', halign: "center"},
                                      },
                          styles: {halign: "center"},                       
                          margin:{left: 10, top: 50},
                          startY: doc.previousAutoTable.finalY + 20                      
        ...
        doc.autoTable(columns, [{}], {theme: 'grid', 
            columnStyles: {
                            cod: {cellWidth: 30, fontStyle: 'bold'},
                            qtd: {cellWidth: 30, fontStyle: 'bold'},
                            desc: {cellWidth: 110, fontStyle: 'bold'},
                            med: {cellWidth: 70, fontStyle: 'bold'},
                            det: {cellWidth: 120, fontStyle: 'bold'},
                            unit: {cellWidth: 60, fontStyle: 'bold'},
                            valor: {cellWidth: 60, fontStyle: 'bold'},
                            nec: {cellWidth: 90, fontStyle: 'bold'}
                          },
            styles: {halign: "center"},                       
            margin:{left: 10, top: 50},
             startY: doc.previousAutoTable.finalY + 20                      
        ...
        items.forEach(function(data){
            ...
            row[0].value = "Total Ambiente: R$" + data.valorTotalAmbiente.toString();
            doc.autoTable(column, row, {margin: {bottom: 0, top: 0, left: 10}, styles: {halign: "center", fillColor: [211,211,211]}, columnStyles: styleColumnAmbient, startY: doc.previousAutoTable.finalY, theme: 'grid'});
            ...
            count = 0;
            doc.autoTable(columns, rows, {margin: {top:0, left: 10}, startY: doc.previousAutoTable.finalY, showHead: 'false',theme: 'grid', columnStyles: {
                            cod: {cellWidth: 30, fontStyle: 'bold'},
                            qtd: {cellWidth: 30, fontStyle: 'bold'},
                            desc: {cellWidth: 110, fontStyle: 'bold'},
                            med: {cellWidth: 70, fontStyle: 'bold'},
        ...
        doc.autoTable(columnTotal, [{valor: "Total: " + totalBudget}],{margin: {top:0, left: 450, right: 7}, showHead: 'false', startY: doc.previousAutoTable.finalY, theme: 'grid', styles: {halign: "right", fillColor: [211,211,211]}});
        
        if(mainBudget.discount > 0){
            console.log("ENTROU");
            doc.autoTable(columnTotal, [{valor: "Desconto: " + mainBudget.discount + "%"}],{margin: {top:0, left: 450, right: 7}, showHead: 'false', startY: doc.previousAutoTable.finalY, theme: 'grid', styles: {halign: "right", fillColor: [211,211,211]}});
            doc.autoTable(columnTotal, [{valor: "Valor Final: " + mainBudget.valorComDesconto}],{margin: {top:0, left: 450, right: 7}, showHead: 'false', startY: doc.previousAutoTable.finalY, theme: 'grid', styles: {halign: "right", fillColor: [211,211,211]}});
        }
